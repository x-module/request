...
// Request HTTP entity for request.
...
type Request struct {
	...
	// Optional reference to the request.Client instance
	Client *Client
...
func (r *Request) Do() (*Response, error) {
	if r.dispatched {
		return nil, errors.New("request: Request was already dispatched")
	}
